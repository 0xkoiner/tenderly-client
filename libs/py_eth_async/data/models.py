...
class Networks:
    ...
    Ethereum = Network(
        name='ethereum',
        rpc='https://ethereum-rpc.publicnode.com',  # 'https://rpc.ankr.com/eth'  'https://eth.llamarpc.com' 'https://ethereum-rpc.publicnode.com'
        chain_id=1,
        tx_type=2,
        coin_symbol='ETH',
    ...
    ZkSync = Network(
        ...
        tx_type=2,
        coin_symbol='ETH',
        explorer='https://mainnet.era.zksync.io',
        api=API(key=config.ZKSYNC_API_KEY, url='https://explorer.zksync.io/', docs='https://era.zksync.io/docs/dev/'),
        # dex=DEX(
        #     name='uniswap_v3', factory='0x1F98431c8aD98523631AE4a59f267346ea31F984',
        #     router='0xE592427A0AEce92De3Edee1F18E0157C05861564'
        # )
    ...
    BSC = Network(
        name='bsc',
        rpc='https://bsc-rpc.publicnode.com', # 'https://rpc.ankr.com/bsc/',
        chain_id=56,
        tx_type=0,
        coin_symbol='BNB',
    ...
    Blast = Network(
        ...
        tx_type=2,
        coin_symbol='ETH',
        explorer='https://https://blastscan.io/',
        api=API(
            key=config.BASE_API_KEY, url='https://api.blastscan.io/api', docs='https://docs.blastscan.io/'
        )
    )
