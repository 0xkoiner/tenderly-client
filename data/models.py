...
class Contract(Singleton):
    UniswapV2Router02 = BaseContract(
        title="UniswapV2Router02", address='0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D', token=False,
        contract_type='Router', abi=read_json(path=(ABIS_DIR, 'UniswapV2Router02.json'))
    )
